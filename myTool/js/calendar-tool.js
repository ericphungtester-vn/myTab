...
var CAL_HOLIDAYS = [
  ...
  { type: 'solar', d: 9, m: 1, cat: 'vn', name: "Vietnamese Students' Day (Học sinh - Sinh viên Việt Nam)" },
  ...
  { type: 'solar', d: 21, m: 4, cat: 'vn', name: 'Book and Reading Culture Day (Sách và Văn hóa đọc Việt Nam)' },
  ...
  { type: 'solar', d: 28, m: 7, cat: 'vn', name: 'Trade Union Foundation Day (Thành lập Công đoàn Việt Nam)' },
  { type: 'solar', d: 19, m: 8, cat: 'vn', name: 'August Revolution Day (Cách mạng tháng Tám)' },
  { type: 'solar', d: 10, m: 9, cat: 'vn', name: 'Fatherland Front Foundation Day (Thành lập Mặt trận Tổ quốc Việt Nam)' },
  ...
  { type: 'solar', d: 18, m: 11, cat: 'vn', name: 'National Great Unity Day (Ngày hội Đại đoàn kết toàn dân tộc)' },
  { type: 'solar', d: 20, m: 11, cat: 'vn', name: "Vietnamese Teachers' Day (Nhà giáo Việt Nam)" },
  { type: 'solar', d: 23, m: 11, cat: 'vn', name: 'Cultural Heritage Day (Di sản Văn hóa Việt Nam)' },
  { type: 'solar', d: 23, m: 11, cat: 'vn', name: 'Red Cross Society Foundation Day (Thành lập Hội Chữ thập đỏ Việt Nam)' },
  { type: 'solar', d: 19, m: 12, cat: 'vn', name: 'National Resistance Day (Toàn quốc kháng chiến)' },
  ...
  { type: 'solar', d: 7, m: 4, cat: 'intl', name: 'World Health Day (Sức khỏe Thế giới)' },
  ...
  { type: 'solar', d: 11, m: 7, cat: 'intl', name: 'World Population Day (Dân số Thế giới)' },
  ...
  { type: 'solar', d: 19, m: 11, cat: 'intl', name: "International Men's Day (Quốc tế Nam giới)" },
  { type: 'solar', d: 10, m: 12, cat: 'intl', name: 'Human Rights Day (Quốc tế Nhân quyền)' },
  { type: 'solar', d: 24, m: 12, cat: 'intl', name: 'Christmas Eve (Đêm Giáng Sinh)' },
  { type: 'solar', d: 25, m: 12, cat: 'intl', name: 'Christmas (Lễ Giáng Sinh)' }
]
